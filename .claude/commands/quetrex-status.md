# Quetrex Status - Dashboard View

Show the current status of the Quetrex AI agent system.
...
1. **Runner Status**
```bash
gh api repos/barnent1/quetrex/actions/runners --jq '.runners[] | "Runner: \(.name) - \(.status)"'
```
