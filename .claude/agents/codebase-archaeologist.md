...
- Integrating Quetrex with legacy systems
...
**Output:** `docs/existing-codebase/.quetrex/patterns.md`

```markdown
# Quetrex Architectural Patterns
...
**Objective:** Create `.quetrex/protection-rules.yml` to prevent dangerous changes.
...
**Output:** `.quetrex/protection-rules.yml`
...
notifications:
  on_rule_violation:
    ...
    - type: "slack"
      channel: "#quetrex-alerts"

  on_critical_path_change:
    - type: "email"
      recipients: ["glen@quetrex.dev"]
...
**Generated by:** Codebase Archaeologist Agent
**Date:** 2025-11-17
**Project:** Quetrex Production Application
...
### For AI Agents
- [Protection Rules](.quetrex/protection-rules.yml) - What NOT to break
- [Architectural Patterns](.quetrex/patterns.md) - How to write code here
...
1. **[Protection Rules](.quetrex/protection-rules.yml)**
...
3. **[Architectural Patterns](.quetrex/patterns.md)**
...
Check `.quetrex/protection-rules.yml` to see if your changes affect protected code.

### Step 2: Understand Patterns
Read `.quetrex/patterns.md` to understand how code should be written in this project.
...
cat .quetrex/protection-rules.yml
...
- .quetrex/protection-rules.yml (7 rules)
- .quetrex/patterns.md (5 patterns)
...
2. Read .quetrex/protection-rules.yml
...
1. Read `.quetrex/patterns.md` (how to write code here)
2. Check `.quetrex/protection-rules.yml` (what's protected)
