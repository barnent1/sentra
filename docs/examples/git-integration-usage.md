...
All types are exported from `@/lib/tauri`:
...
import { getGitLog, GitCommit } from '@/lib/tauri';
...
```tsx
import { useState, useEffect } from 'react';
import { getGitStatus, GitStatus } from '@/lib/tauri';
...
```tsx
import { useState, useEffect } from 'react';
import { getGitDiff, GitDiff } from '@/lib/tauri';
...
```tsx
import { useState, useEffect } from 'react';
import { getGitLog, getGitDiff, GitCommit, GitDiff } from '@/lib/tauri';
