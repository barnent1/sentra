...
export async function saveSpec(
  ...
  return {
    ...
    project: projectName,
    filePath: `${projectPath}/.quetrex/specs/mock-spec.spec.20251113.md`,
    version: 1,
 ...
 * Uses the Barnhardt-Enterprises-Inc/quetrex-template-nextjs template
 */
...
/**
 * Create a new project with Quetrex configuration
 */
