...
export const useAgentsStore = defineStore('agents', () => {
  ...
  const fetchAgents = async (): Promise<void> => {
    try {
      ...
      console.log('Fetching agents from API:', `${apiUrl}/api/evolution/agents`)
      
      const response = await fetch(`${apiUrl}/api/evolution/agents`, {
        headers: {
      ...
      // Process the agent data from the API
      ...
      console.log(`Loaded ${agents.value.length} agents from API`)
