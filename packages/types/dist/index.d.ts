...
export declare const EventType: {
    ...
    readonly AGENT_SPAWN: "agent_spawn";
    readonly AGENT_TERMINATE: "agent_terminate";
    readonly LEARNING_EVENT: "learning_event";
    readonly PERFORMANCE_MILESTONE: "performance_milestone";
};
