      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            ...
            <toggle-switch v-model="notifications.evolutionEvents" />
          </div>
          ...
          <div class="flex items-center justify-between">
            ...
            <toggle-switch v-model="notifications.performanceAlerts" />
          </div>
          ...
          <div class="flex items-center justify-between">
            ...
            <toggle-switch v-model="notifications.agentStatus" />
          </div>
        </div>
      </div>
