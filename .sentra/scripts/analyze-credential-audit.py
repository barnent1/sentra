...
Usage:
    python3 .sentra/scripts/analyze-credential-audit.py /tmp/credential-audit.log
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("  python3 .sentra/scripts/analyze-credential-audit.py /tmp/credential-audit.log", file=sys.stderr)
        sys.exit(1)
