# Quick Start: Figma → Sentra Import
...
```bash
mkdir -p .sentra/architect-sessions/my-project
```

Create `.sentra/architect-sessions/my-project/ui-screens.md`:
...
```bash
python3 .sentra/scripts/figma-import.py \
...
- Create `.sentra/architect-sessions/PROJECT_NAME/ui-screens.md`
- See example in `.sentra/architect-sessions/example-project/`
