...
**Part of Sentra's AI-Powered SaaS Factory**
...
Edit `.sentra/dependency-graph.yml` to define:
...
```bash
python .sentra/scripts/check-dependencies.py --issue 45
```
...
python .sentra/scripts/check-dependencies.py --issue 45 --verbose
...
python .sentra/scripts/dependency-manager.py --check 45

# Show blocked issues
python .sentra/scripts/dependency-manager.py --blocked

# Show ready issues
python .sentra/scripts/dependency-manager.py --ready

# Show ready issues in specific batch
python .sentra/scripts/dependency-manager.py --ready --batch batch_2

# Check conflicts for issue
python .sentra/scripts/dependency-manager.py --conflicts 45
    ...
    steps:
      ...
      - name: Trigger Next Issues
        run: |
          ...
          READY=$(python .sentra/scripts/dependency-manager.py --ready)
...
**Validate format:**
```bash
python -m json.tool .sentra/progress.json
```
...
- [HANDOVER-2025-11-17-SENTRA-COMPLETE-VISION.md](../../HANDOVER-2025-11-17-SENTRA-COMPLETE-VISION.md) - Complete Sentra vision
- [.sentra/dependency-graph.example.yml](../dependency-graph.example.yml) - Example dependency graph
...
**Part of:** Sentra AI-Powered SaaS Factory
