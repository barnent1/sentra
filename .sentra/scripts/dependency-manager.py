...
Reads dependency graph from .sentra/dependency-graph.yml
Tracks progress in .sentra/progress.json

Part of Sentra's AI-Powered SaaS Factory architecture.
"""
...
class DependencyManager:
    ...
    def __init__(self, project_root: Path):
        ...
        self.dependency_graph_path = project_root / ".sentra" / "dependency-graph.yml"
        self.progress_path = project_root / ".sentra" / "progress.json"
    ...
    def _load_dependency_graph(self) -> Dict[str, Any]:
        ...
        if not self.dependency_graph_path.exists():
            raise FileNotFoundError(
                ...
                f"Create .sentra/dependency-graph.yml first."
            )
