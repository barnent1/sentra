...
# Files are in .sentra/ and .claude/ directories
```
...
**Files:**
- `.sentra/memory/patterns.md` - 15 default patterns
...
python3 .sentra/scripts/auto-refactor.py --risk=low --max-files=10
...
0 2 * * * cd /path/to/project && python3 .sentra/scripts/auto-refactor.py --risk=low --auto-commit

# Weekly metrics (Monday 8:30 AM)
30 8 * * 1 cd /path/to/project && python3 .sentra/scripts/metrics-collector.py
```
...
**Solutions:**
1. Run metrics collector: `python3 .sentra/scripts/metrics-collector.py`
2. Regenerate dashboard: `python3 .sentra/scripts/dashboard-generator.py`
...
- Phase 1: `.sentra/memory/ARCHITECTURE-INTELLIGENCE-SYSTEM.md`
- Phase 2: `PERFECT-AGENTIC-STRUCTURE.md`
- Phase 3: `.sentra/memory/PHASE_3_EVOLVER.md`
- Integration: `.sentra/config/phase3-integration.md`
- Testing: `.sentra/config/testing-strategy.md`
...
python3 .sentra/scripts/auto-refactor.py --risk=low        # Auto-fix
open .sentra/metrics/dashboard.html                         # View metrics
...
# Configuration
vim .sentra/config/auto-refactor.json                      # Edit rules
crontab .sentra/config/crontab                             # Install cron
```
