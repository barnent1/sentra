...
- [ ] Create separate Vercel project: `sentra-prototypes`
- [ ] Configure custom domain: `prototypes.sentra.app`
- [ ] Set up DNS records
...
### Database Updates
- [ ] Add `deploymentUrl` field (Sentra URLs)
- [ ] Add `deploymentStatus` tracking
- [ ] Update prototype creation to include deployment
- [ ] Add indexes for performance

### API Endpoint Updates
- [ ] Update `/api/prototypes/generate` to deploy to Sentra
...
- [ ] Prototypes deploy to prototypes.sentra.app
...
- [ ] Prototype deploys to Sentra-hosted URL
...
- Sentra-hosted deployments (not v0 URLs)
