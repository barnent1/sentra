...
4. On approval, updates `.quetrex/memory/patterns.md`
5. Architecture scanner automatically picks up new patterns

**Files involved:**
- `.quetrex/agents/pattern-learner.md` (Phase 3)
- `.quetrex/memory/patterns.md` (Phase 1)
...
Read({ file_path: ".quetrex/memory/patterns.md" })

# Discovers new patterns and proposes them
# User approves

# Pattern learner updates patterns.md
Edit({ file_path: ".quetrex/memory/patterns.md", ... })
...
**Files involved:**
- `.quetrex/scripts/auto-refactor.py` (Phase 3)
- `.claude/scripts/architecture-scanner.py` (Phase 1)
...
**Phase 3:**
1. Auto-refactor fixes violations automatically: `python3 .quetrex/scripts/auto-refactor.py --risk=low`
...
```json
// .quetrex/config/auto-refactor.json
{
  "risk_levels": {
...
**Solution:**
- Run metrics collector: `python3 .quetrex/scripts/metrics-collector.py`
- Regenerate dashboard: `python3 .quetrex/scripts/dashboard-generator.py`
