...
for i in {001..048}; do
  gh issue create \
    --title "$(grep '^title:' .quetrex/issues-bookmark-test/issue-${i}.md | cut -d'"' -f2)" \
    --body-file ".quetrex/issues-bookmark-test/issue-${i}.md" \
...
gh issue create \
  ...
  --body-file ".quetrex/issues-bookmark-test/issue-001.md" \
...
*Generated by Meta-Orchestrator Agent for Quetrex Project*
