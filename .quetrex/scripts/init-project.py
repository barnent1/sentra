...
"""
Quetrex AI-Powered SaaS Factory - New Project Initializer

This script initializes a NEW project structure for the Quetrex SaaS Factory.
...
**Factory:** Quetrex AI-Powered SaaS Factory
...
**Powered by:** Quetrex AI-Powered SaaS Factory
**Documentation:** .quetrex/README.md
"""
...
def print_next_steps(project_name: str) -> None:
    ...
    log_header("Project Initialized! 🚀")
    ...
    print(f"   .quetrex/architect-sessions/{project_name}/sessions/session-001-initial-architecture.md")
    print()
    print(f"{Colors.CYAN}Project Structure:{Colors.NC}")
    print(f"  .quetrex/architect-sessions/{project_name}/")
    print("    ├── sessions/              # Session history")
    print("    ├── specs/                 # Generated specs")
    print("    ├── coverage/              # Coverage tracking")
    print("    ├── progress.json          # Progress tracker")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Initialize a new Quetrex project'
    )
    parser.add_argument(
        '--name',
        required=True,
    ...
    print(f"{Colors.PURPLE}║{' ' * 58}║{Colors.NC}")
    print(f"{Colors.PURPLE}║  Quetrex Project Initializer - New Project{' ' * 15}║{Colors.NC}")
    print(f"{Colors.PURPLE}║{' ' * 58}║{Colors.NC}")
    print(f"{Colors.PURPLE}╚{'═' * 58}╝{Colors.NC}")
    print()
    ...
    # Get base directory
    base_dir = Path('.quetrex')
    if not base_dir.exists():
        log_error(f"Quetrex directory not found: {base_dir}")
        log_info("Run: ./scripts/setup-quetrex.sh")
        sys.exit(1)
