...
class FigmaImporter:
    ...
    def import_design(
        ...
        """
        logger.info("🎨 Figma → Quetrex Import")
    ...
    def load_architect_specs(self, project_name: str) -> Dict[str, Dict[str, Any]]:
        ...
        """
        session_dir = self.project_dir / ".quetrex" / "architect-sessions" / project_name
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Figma → Quetrex Import: Merge Figma designs with behavioral specs",
