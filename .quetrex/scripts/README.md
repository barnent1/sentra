# Quetrex Automation Scripts

Python automation scripts for the Quetrex AI-Powered SaaS Factory system.

---

## Overview

These scripts automate common tasks in the Quetrex development workflow:
...
**What it does:**
- Creates `.quetrex/architect-sessions/[project-name]/` structure
...
**Purpose:** Initialize Quetrex for EXISTING codebase
...
python .quetrex/scripts/auto-refactor.py --analyze

# Apply refactoring
python .quetrex/scripts/auto-refactor.py --refactor path/to/file.ts

# Dry run (show what would change)
python .quetrex/scripts/auto-refactor.py --refactor path/to/file.ts --dry-run
```
...
python .quetrex/scripts/auto-refactor.py --analyze src/services/

# Refactor auth service
python .quetrex/scripts/auto-refactor.py --refactor src/services/auth.ts

# Generate report
python .quetrex/scripts/auto-refactor.py --report
```
...
python .quetrex/scripts/dashboard-generator.py --output dashboard.html

# Generate JSON data only
python .quetrex/scripts/dashboard-generator.py --json
...
python .quetrex/scripts/metrics-collector.py --collect

# Show metrics summary
python .quetrex/scripts/metrics-collector.py --summary

# Export metrics to JSON
python .quetrex/scripts/metrics-collector.py --export metrics.json
```
...
```bash
# Check for conflicts
python .quetrex/scripts/check-dependencies.py --check

# Show updates available
python .quetrex/scripts/check-dependencies.py --updates

# Verify dependency graph
python .quetrex/scripts/check-dependencies.py --verify
```
...
python .quetrex/scripts/check-dependencies.py --resolve
```
...
python .quetrex/scripts/dependency-manager.py --graph

# Check if feature can be built
python .quetrex/scripts/dependency-manager.py --can-build feature-name

# Get build order
python .quetrex/scripts/dependency-manager.py --build-order
```
...
python .quetrex/scripts/dependency-manager.py --can-build user-profile
...
python .quetrex/scripts/update-progress.py --session 5 --complete

# Mark feature complete
python .quetrex/scripts/update-progress.py --feature user-auth --status complete

# Show current progress
python .quetrex/scripts/update-progress.py --show
```
...
python .quetrex/scripts/update-progress.py --session 3 --complete
...
```bash
# Import Figma file
python .quetrex/scripts/figma-import.py --url "figma.com/file/abc123"

# Import specific frame
python .quetrex/scripts/figma-import.py --url "figma.com/file/abc123" --frame "Login Screen"

# Generate specs
python .quetrex/scripts/figma-import.py --url "figma.com/file/abc123" --specs
```
...
python .quetrex/scripts/figma-import.py \
...
python .quetrex/scripts/init-project.py --name "my-saas"
...
python .quetrex/scripts/dependency-manager.py --can-build new-feature

# 2. Import design (if from Figma)
python .quetrex/scripts/figma-import.py --url "figma.com/file/..."
...
# 4. Update progress
python .quetrex/scripts/update-progress.py --feature new-feature --status complete
...
cat .quetrex/refactor-report.md

# 3. Apply safe refactorings
python .quetrex/scripts/auto-refactor.py --refactor src/services/ --dry-run

# 4. If looks good, apply
python .quetrex/scripts/auto-refactor.py --refactor src/services/
...
1. Create script in `.quetrex/scripts/`
...
```bash
# Dry run mode
python .quetrex/scripts/script.py --dry-run

# Verbose output
python .quetrex/scripts/script.py --verbose

# Debug mode
python .quetrex/scripts/script.py --debug
```
...
# Make executable
chmod +x .quetrex/scripts/script.py
```
...
python .quetrex/scripts/script.py
```
