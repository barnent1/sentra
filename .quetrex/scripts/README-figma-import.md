...
This script is part of Quetrex's AI-Powered SaaS Factory architecture. It bridges the gap between visual design (Figma) and behavioral specifications (Architect sessions) to create comprehensive screen specifications that agents can implement.
...
See `.quetrex/architect-sessions/example-project/ui-screens.md` for complete example.
...
```
Architect UI screens spec not found: .quetrex/architect-sessions/bookmark-manager/ui-screens.md
...
- [HANDOVER-2025-11-17-QUETREX-COMPLETE-VISION.md](../../HANDOVER-2025-11-17-QUETREX-COMPLETE-VISION.md) - Component 3: Figma → Quetrex Import
- [Example architect session](.quetrex/architect-sessions/example-project/)
