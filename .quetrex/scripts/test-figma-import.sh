...
if [ -f ".quetrex/architect-sessions/example-project/ui-screens.md" ]; then
...
python3 .quetrex/scripts/figma-import.py --help >/dev/null 2>&1 && echo "  ✅ Help works" || {
    echo "  ❌ Help failed"
    exit 1
}
...
output=$(python3 .quetrex/scripts/figma-import.py \
...
echo "  3. Run: python3 .quetrex/scripts/figma-import.py --figma-url <url> --project example-project"
