...
Enable Quetrex's voice architect to generate working, interactive prototypes during conversation. Users can show these prototypes to customers for validation before development begins.
...
### Hosting: Quetrex-Hosted Demos (NOT v0 URLs)
- **Reason:** User preference for branded demos
- **Deployment:** Vercel preview deployments per prototype
- **URL Format:** `https://<project-slug>-prototype.quetrex.app`
...
interface DeploymentResponse {
  url: string; // https://<project>-prototype.quetrex.app
...
**If YES:**
1. Save complete specification to `.quetrex/architect-sessions/{project}/spec.yml`
...
1. **Read Specification**
   - Load architect spec from `.quetrex/architect-sessions/{project}/spec.yml`
...
6. **Return URL**
   - Share Quetrex-hosted URL with user
...
**Project Structure:**
```
quetrex-prototypes/ (Separate Vercel project)
├── prototypes/
│   ├── project-abc-v1/
...
**URL Structure:**
- Main: `https://prototypes.quetrex.app`
- Project: `https://prototypes.quetrex.app/project-abc` → Latest version
- Specific: `https://prototypes.quetrex.app/project-abc/v2` → Version 2
...
test('User toggles mute button', async ({ page }) => {
  await page.goto('https://prototypes.quetrex.app/project-abc');
...
- Quetrex: $5 per working prototype
- **99% cost savings**
...
- Custom domain setup (prototypes.quetrex.app)
- Database schema for prototypes
- API endpoints

**Definition of Done:**
- Prototypes hosted on quetrex.app domain
...
# Prototype Hosting
PROTOTYPE_BASE_URL=https://prototypes.quetrex.app
```
...
- [ ] Verify Quetrex-hosted URL works
