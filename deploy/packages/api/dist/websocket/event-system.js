...
class EvolutionEventBroadcaster {
    ...
    getAllowedChannels = (user) => {
        ...
        if (user.role === 'user') {
            return allChannelsWithObservability.filter(channel => !channel.startsWith('system:') || channel === 'system:health');
        }
     ...
     */
    broadcastToolUsageStarted = (payload) => {
        this.io.to('observability:tool_started').emit(exports.WebSocketEvents.TOOL_USAGE_STARTED, payload);
    ...
    broadcastToolUsageCompleted = (payload) => {
        this.io.to('observability:tool_completed').emit(exports.WebSocketEvents.TOOL_USAGE_COMPLETED, payload);
    ...
    broadcastAgentDecision = (payload) => {
        this.io.to('observability:agent_decision').emit(exports.WebSocketEvents.AGENT_DECISION, payload);
    ...
    broadcastMemoryOperation = (payload) => {
        this.io.to('observability:memory_operation').emit(exports.WebSocketEvents.AGENT_MEMORY_OPERATION, payload);
    ...
    broadcastCoordination = (payload) => {
        this.io.to('observability:coordination').emit(exports.WebSocketEvents.AGENT_COORDINATION, payload);
    ...
    broadcastPerformancePulse = (payload) => {
        this.io.to('observability:performance_pulse').emit(exports.WebSocketEvents.PERFORMANCE_PULSE, payload);
    ...
    broadcastLearningPattern = (payload) => {
        this.io.to('observability:learning_pattern').emit(exports.WebSocketEvents.LEARNING_PATTERN, payload);
    ...
    broadcastBehaviorPattern = (payload) => {
        this.io.to('observability:behavior_pattern').emit(exports.WebSocketEvents.BEHAVIOR_PATTERN, payload);
