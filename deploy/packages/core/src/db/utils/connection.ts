 ...
 */
export const createConnection = (config: Partial<DatabaseConfig> = {}) => {
 ...
 */
export const getDatabase = (config?: Partial<DatabaseConfig>) => {
  if (!db) {
 ...
 */
export const testConnection = async (config?: Partial<DatabaseConfig>) => {
  try {
