...
/**
 * Tool usage started event (pre-tool hook)
 */
export interface ToolUsageStartedEvent extends BaseEvent {
    readonly type: 'tool_usage_started';
    readonly category: typeof EventCategory.AUDIT;
    readonly data: {
        readonly agentId: AgentInstanceId;
        readonly taskId?: TaskId;
...
/**
 * Tool usage completed event (post-tool hook)
 */
export interface ToolUsageCompletedEvent extends BaseEvent {
    readonly type: 'tool_usage_completed';
    readonly category: typeof EventCategory.AUDIT;
    readonly data: {
        readonly agentId: AgentInstanceId;
        readonly taskId?: TaskId;
...
/**
 * Agent decision point event (decision making process)
 */
...
/**
 * Agent memory operation event (context and memory tracking)
 */
export interface AgentMemoryOperationEvent extends BaseEvent {
    readonly type: 'agent_memory_operation';
    readonly category: typeof EventCategory.AUDIT;
    readonly data: {
        readonly agentId: AgentInstanceId;
        readonly sessionId: string;
...
/**
 * Agent coordination event (multi-agent communication)
 */
export interface AgentCoordinationEvent extends BaseEvent {
    readonly type: 'agent_coordination';
    readonly category: typeof EventCategory.COMMUNICATION;
    readonly data: {
        readonly initiatorId: AgentInstanceId;
...
/**
 * Real-time performance pulse event (live metrics for dashboard)
 */
export interface PerformancePulseEvent extends BaseEvent {
    readonly type: 'performance_pulse';
    readonly category: typeof EventCategory.PERFORMANCE;
    readonly data: {
        readonly agentId: AgentInstanceId;
        readonly sessionId: string;
...
/**
 * Agent learning pattern event (learning insights)
 */
export interface AgentLearningPatternEvent extends BaseEvent {
    readonly type: 'agent_learning_pattern';
    readonly category: typeof EventCategory.LEARNING;
    readonly data: {
        readonly agentId: AgentInstanceId;
...
export declare const isObservabilityEvent: (event: BaseEvent) => event is ToolUsageStartedEvent | ToolUsageCompletedEvent | AgentDecisionEvent | AgentMemoryOperationEvent | AgentCoordinationEvent | PerformancePulseEvent | AgentLearningPatternEvent;
